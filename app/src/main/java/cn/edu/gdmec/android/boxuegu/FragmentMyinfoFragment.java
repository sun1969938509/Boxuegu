...
public class FragmentMyinfoFragment extends Fragment implements View.OnClickListener {
    ...
    private RelativeLayout rlCourseHistroy;
    private ImageView ivCourseHistroyicon;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        rlCourseHistroy = (RelativeLayout) view.findViewById(R.id.rl_course_histroy);
        ivCourseHistroyicon = (ImageView) view.findViewById(R.id.iv_course_histroyicon);
        ...
        rlCourseHistroy.setOnClickListener(this);
